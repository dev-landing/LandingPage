...
const PageFive = () => {
  ...
  return (
    <div className="flex justify-start items-center w-full h-screen">
      <div id="page-5-container" className="flex sm:flex-col-reverse justify-center items-center w-11/12 gap-14 sm:gap-2 bg-gradient-to-b from-[#6a99c548] to-[#01016860] rounded-e-full overflow-visible translate-x-[-2000px] h-4/5">
