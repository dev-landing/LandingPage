...
const PageTwo = () => {
  ...
  return (
    <div style={{ 
      ...
      <div className="flex justify-between w-[90%] gap-20 bg-gradient-to-b from-[#6a99c548] to-[#01016860] rounded-s-full h-[75%] overflow-visible translate-x-[2000px]">
        <video autoPlay loop muted height={"auto"} width={"40%"}>
          <source src="/books.mp4" type="video/mp4" />
        </video>
        <div className="flex flex-col justify-center items-end w-[50%] mr-10">
